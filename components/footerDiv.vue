<template>
  ...
  <footer class="bg-gray-800 text-gray-300 px-6 lg:px-8 py-6">
    ...
    <div class="max-w-screen-xl mx-auto flex flex-col items-center mt-8">
      <div class="flex items-center space-x-2">

        <a
          href="http://instagram.com/codingstark/"
          target="_blank"
        ...
        <a
          href="https://twitter.com/codingstark"
          class="hover:text-gray-100"
          target="_blank"
        >
          ...
          href="mailto:codingstark.com@gmail.com"
          class="hover:text-gray-100"
          target="_blank"
        >
